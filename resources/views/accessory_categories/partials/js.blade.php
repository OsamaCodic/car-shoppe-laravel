<script>
    $(document).ready(function () {
        ...
        // live search response
            ...
            {
                $.ajax({
                    url:"{{ url('admin/accessory_types_live_search') }}",
                    method:'GET',
                    data:{query:query},
                    dataType:'json',
        ...
        // Type Create/Update
            $("#accessorycategoryForm").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url : $('#accessorycategoryForm').attr('action'),
                        type: $('#accessorycategoryForm').attr('method'),
                        data: $('#accessorycategoryForm').serialize(),
