...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row mb-2">
            <div class="col-md-10">
                <h1 class="h3 mb-2 text-gray-800">All Accessory Brands</h1>
            </div>
            <div class="col-md-2">
                <a href="{{url('admin/accessory_brands/create')}}" type="button" class="btn btn-block btn-primary rounded-pill btn-sm zoomBtn"><i class="fa fa-plus ml-2" aria-hidden="true"></i></a>
            </div>  
        </div>
